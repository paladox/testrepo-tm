...
class WebVideoTranscode {
	...
	*/
	...
	public static function TimedMediaEncoding() {
		...
		if ( $wgEnabledAudioTranscodeSet != "OGG_VORBIS" || $wgEnabledAudioTranscodeSet != WebVideoTranscode::ENC_OGG_VORBIS ) {
		...
		if ( $wgEnabledAudioTranscodeSet != "ENC_MP3" || $wgEnabledAudioTranscodeSet != WebVideoTranscode::ENC_ENC_MP3 ) {
		...
		if ( $wgEnabledAudioTranscodeSet != "ENC_AAC" || $wgEnabledAudioTranscodeSet != WebVideoTranscode::ENC_ENC_AAC ) {
