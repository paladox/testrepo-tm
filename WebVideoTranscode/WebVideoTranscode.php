...
class WebVideoTranscode {
	...
	*/
	...
	// mjpeg profiles (for iOS last-ditch fallback):
	const ENC_MJPEG_160P = '160p.avi';
	const ENC_MJPEG_240P = '240p.avi';
	const ENC_MJPEG_360P = '360p.avi';
	...
	public static $derivativeSettings = array(
		...
		WebVideoTranscode::ENC_MJPEG_160P =>
			array(
				...
				'type'                       => 'video/avi; codecs="jpeg, ulaw"',
			),
		...
		WebVideoTranscode::ENC_MJPEG_360P =>
			array(
				'maxSize'                    => '640x360',
				'videoBitrate'               => '512',
				'framerate'                  => '15',
