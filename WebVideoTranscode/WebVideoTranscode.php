...
class WebVideoTranscode {
	...
	*/
	...
	public static function TimedMediaEncoding() {
		...
		if ( $wgEnabledAudioTranscodeSet != "OGG_VORBIS" || $wgEnabledAudioTranscodeSet != WebVideoTranscode::ENC_OGG_VORBIS || $wgEnabledTranscodeSet = "WebVideoTranscode::ENC_OGG_VORBIS" != true ) {
