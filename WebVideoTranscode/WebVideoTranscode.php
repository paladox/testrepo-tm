...
class WebVideoTranscode {
	...
	*/
	...
	// H265 mp4 profiles:
	const ENC_H265_160P = '160p.h265.mp4';
	const ENC_H265_240P = '240p.h265.mp4';
	const ENC_H265_360P = '360p.h265.mp4';
	const ENC_H265_480P = '480p.h265.mp4';
	const ENC_H265_720P = '720p.h265.mp4';
	const ENC_H265_1080P = '1080p.h265.mp4';
	const ENC_H265_1440P = '1440p.h265.mp4';
	const ENC_H265_2160P = '2160p.h265.mp4';
	...
	*/
	public static $derivativeSettings = array(
		...
		// Audio profiles
		// mp4 H265 transcode:
		WebVideoTranscode::ENC_H265_160P =>
			array(
				'maxSize' => '288x160',
				'videoCodec' => 'h265',
				'videoBitrate' => '256',
				...
				'channels' => '2',
				'audioBitrate' => '40k',
				'type' => 'video/mp4; codecs="hvc1.1.6.L93.90, mp4a.40.2"',
			),

		WebVideoTranscode::ENC_H265_240P =>
			array(
				'maxSize' => '426x240',
				'videoCodec' => 'h265',
				'videoBitrate' => '256',
		...
		WebVideoTranscode::ENC_H265_360P =>
			array(
				'maxSize' => '640x360',
				'videoCodec' => 'h265',
				'videoBitrate' => '256',
		...
		WebVideoTranscode::ENC_H265_1440P =>
			array(
				'maxSize' => '2560x1440',
				'videoCodec' => 'h265',
				'videoBitrate' => '8192k',
