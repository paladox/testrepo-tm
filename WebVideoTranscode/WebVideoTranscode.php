...
class WebVideoTranscode {
	...
	*/
	...
	public static function TimedMediaEncoding() {
		...
		if ( $wgEnabledTranscodeSet != "OGV_160P" || $wgEnabledTranscodeSet != WebVideoTranscode::ENC_OGV_160P || $wgEnabledTranscodeSet != "WebVideoTranscode::ENC_OGV_160P"  || WebVideoTranscode::ENC_OGV_160P != OGV_160P ) {
