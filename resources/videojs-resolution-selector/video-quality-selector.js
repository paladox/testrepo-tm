 ...
 *
 * More hacks by User:Paladox2017 (Gerrit name Paladox) Changed data-res to data-shorttitle to show list of avalible resolutions.
 */
...
(function( _V_ ) {
	...
	_V_.plugin( 'resolutionSelector', function( options ) {
		...
		while ( i > 0 ) {
			...
			if ( ! sources[i]['data-shorttitle'] ) { continue; }
			
			current_res = sources[i]['data-shorttitle'];
		...
		player.getCurrentRes = function() {
			...
			if ( typeof player.currentRes !== 'undefined' ) {
				...
				try {
					...
					return res = sources[0]['data-shorttitle'];
