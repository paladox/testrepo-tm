  ...
  Component.prototype.emitTapEvents = function emitTapEvents() {
    ...
    this.on('touchstart', function (event) {
      ...
      if (event.touches.length === 1) {
        ...
        firstTouch = (0, _objectAssign2['default'])({}, event.touches[0]);
...
var SeekBar = (function (_Slider) {
  ...
  SeekBar.prototype.updateARIAAttributes = function updateARIAAttributes() {
    ...
    this.el_.setAttribute('aria-valuetext', (0, _utilsFormatTimeJs2['default'])(time, this.player_.duration())); // human readable value of progress bar (time complete)
  };
  ...
  ChaptersButton.prototype.createMenu = function createMenu() {
    ...
    if (menu === undefined) {
      ...
      menu.contentEl().appendChild(Dom.createEl('li', {
        ...
        innerHTML: (0, _utilsToTitleCaseJs2['default'])(this.kind_),
        tabIndex: -1
      }));
    }
...
var DurationDisplay = (function (_Component) {
  ...
  DurationDisplay.prototype.updateContent = function updateContent() {
    ...
    if (duration) {
      ...
      var formattedTime = (0, _utilsFormatTimeJs2['default'])(duration);
...
var RemainingTimeDisplay = (function (_Component) {
  ...
  RemainingTimeDisplay.prototype.updateContent = function updateContent() {
    if (this.player_.duration()) {
      ...
      var formattedTime = (0, _utilsFormatTimeJs2['default'])(this.player_.remainingTime());
      this.contentEl_.innerHTML = '<span class="vjs-control-text">' + localizedText + '</span> -' + formattedTime;
    }
...
var MediaError = function MediaError(code) {
  if (typeof code === 'number') {
    ...
    // object
    (0, _objectAssign2['default'])(this, code);
  }
...
var MenuButton = (function (_Button) {
  ...
  MenuButton.prototype.createMenu = function createMenu() {
    ...
    if (this.options_.title) {
      menu.contentEl().appendChild(Dom.createEl('li', {
        className: 'vjs-menu-title',
        innerHTML: (0, _utilsToTitleCaseJs2['default'])(this.options_.title),
        tabIndex: -1
      }));
    }
...
var MenuItem = (function (_Button) {
  ...
  MenuItem.prototype.createEl = function createEl(type, props) {
    return _Button.prototype.createEl.call(this, 'li', (0, _objectAssign2['default'])({
...
var Player = (function (_Component) {
  ...
  function Player(tag, options, ready) {
    ...
    // an infinite loop.
    var playerOptionsCopy = (0, _utilsMergeOptionsJs2['default'])(this.options_);
  ...
  Player.prototype.createEl = function createEl() {
    ...
    // video element
    this.styleEl_ = _globalDocument2['default'].createElement('style');
  ...
  *
    ...
    if (this.tech && this.tech.isReady_) {
      ...
      try {
        ...
        if (this.tech[method] === undefined) {
          (0, _utilsLogJs2['default'])('Video.js: ' + method + ' method not defined for ' + this.techName + ' playback technology.', e);
        } else {
          // When a method isn't available on the object it throws a TypeError
          if (e.name === 'TypeError') {
            (0, _utilsLogJs2['default'])('Video.js: ' + method + ' unavailable on ' + this.techName + ' playback technology element.', e);
  ...
  Player.prototype.bufferedPercent = function bufferedPercent() {
    return (0, _utilsBufferJs.bufferedPercent)(this.buffered(), this.duration());
  };
  ...
  Player.prototype.selectSource = function selectSource(sources) {
    ...
    for (var i = 0, j = this.options_.techOrder; i < j.length; i++) {
      var techName = (0, _utilsToTitleCaseJs2['default'])(j[i]);
  ...
  Player.prototype.languages = function languages() {
    return (0, _utilsMergeOptionsJs2['default'])(Player.prototype.options_.languages, this.languages_);
  };
  ...
  Player.prototype.toJSON = function toJSON() {
    var options = (0, _utilsMergeOptionsJs2['default'])(this.options_);
    ...
    for (var i = 0; i < tracks.length; i++) {
      ...
      track = (0, _utilsMergeOptionsJs2['default'])(track);
...
var Flash = (function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    var flashVars = (0, _objectAssign2['default'])({
    ...
    var params = (0, _objectAssign2['default'])({
      'wmode': 'opaque', // Opaque is needed to overlay controls, but can affect playback performance
      'bgcolor': '#000000' // Using bgcolor prevents a white flash when the object is loading
    }, options.params);

    // Merge default attributes with ones passed in
    var attributes = (0, _objectAssign2['default'])({
      'id': objId,
  ...
  Flash.prototype.seekable = function seekable() {
    ...
    if (duration === 0) {
      return (0, _utilsTimeRangesJs.createTimeRange)();
    }
    return (0, _utilsTimeRangesJs.createTimeRange)(0, duration);
  };
  ...
  Flash.prototype.buffered = function buffered() {
    return (0, _utilsTimeRangesJs.createTimeRange)(0, this.el_.vjs_getProperty('buffered'));
  };
...
Flash.getEmbedCode = function (swf, flashVars, params, attributes) {
  ...
  params = (0, _objectAssign2['default'])({
    'movie': swf,
...
var TextTrackSettings = (function (_Component) {
  ...
  TextTrackSettings.prototype.restoreSettings = function restoreSettings() {
    var _safeParseTuple = (0, _safeJsonParseTuple2['default'])(_globalWindow2['default'].localStorage.getItem('vjs-text-track-settings'));
...
var loadTrack = function loadTrack(src, track) {
  (0, _xhrJs2['default'])(src, Fn.bind(this, function (err, response, responseBody) {
    if (err) {
 ...
 */
videojs.players = (0, _utilsCreateDeprecationProxyJs2['default'])(_player2['default'].players, {
...
videojs.addLanguage = function (code, data) {
  ...
  return (0, _lodashCompatObjectMerge2['default'])(videojs.options.languages, (_merge = {}, _merge[code] = data, _merge))[code];
};
...
var xhr = function xhr(options, callback) {
  ...
  options = (0, _utilsMergeOptionsJs2['default'])({
    method: 'GET',
    timeout: 45 * 1000
  }, options);
