...
mw.EmbedPlayerNative = {
	...
	*/
	_onpause: function(){
		...
		if( !this.seeking && !this.userSlide 
				&& 
			timeSincePlay > mw.config.get( 'EmbedPlayer.MonitorRate' ) 
		){
			_this.parent_pause();
	...
	*/
	_onplay: function(){
		...
		if( ! this.ignoreNextNativeEvent && this._propagateEvents && this.paused && ( mw.config.get('EmbedPlayer.EnableIpadHTMLControls') === true ) ){
			this.parent_play();
		} else {
