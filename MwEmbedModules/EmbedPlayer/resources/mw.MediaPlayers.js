...
mw.MediaPlayers.prototype = {
	...
	init: function() {
		...
		this.defaultPlayers['video/ogg'] = ['Native', 'Vlc', 'OgvJs', 'OgvSwf', 'Java', 'Generic', 'VLCApp'];
		...
		this.defaultPlayers['application/ogg'] = ['Native', 'Vlc', 'OgvJs', 'OgvSwf', 'Java', 'Generic', 'VLCApp'];
		this.defaultPlayers['audio/ogg'] = ['Native', 'Vlc', 'OgvJs', 'OgvSwf', 'Java', 'VLCApp'];
