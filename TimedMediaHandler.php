...
if ( function_exists( 'wfLoadExtension' ) ) {
	...
	$wgMessagesDirs['MwEmbed.TimedText'] = __DIR__ . '/MwEmbedModules/EmbedPlayer/i18n';
	/* wfWarn(
		'Deprecated PHP entry point used for TimedMediaHandler extension. Please use wfLoadExtension instead, ' .
