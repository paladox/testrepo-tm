...
class ApiQueryVideoInfo extends ApiQueryImageInfo {
	...
	public function getInfo( $file, $prop, $result, $thumbParams = null, $version = 'latest' ) {
...
//		return array_keys( ApiQueryVideoInfo::getPropertyMessages( $filter ) );
//	}
...
//				ApiBase::PARAM_TYPE => ApiQueryVideoInfo::getPropertyNames(),
//				ApiBase::PARAM_HELP_MSG_PER_VALUE => ApiQueryVideoInfo::getPropertyMessages(),
//			]
//		], $params );
