...
class TimedMediaHandlerHooks {
	...
	public static function registerExtension() {
		...
		$wgEnabledTranscodeSet = array_merge( $wgEnabledTranscodeSet, $wgTMHEnabledVideoTranscodeSet );

		$wgEnabledAudioTranscodeSet = array_merge( $wgEnabledAudioTranscodeSet, $wgTMHEnabledAudioTranscodeSet );
	}
