<?php
/**
 * move transcodes from thumb to media container
 *
 */
...
class MoveTranscodes extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->mDescription = "move transcodes from thumb to media container.";
	}
				...
				if( $file->repo->fileExists( $oldPath ) ){
					if( $file->repo->fileExists( $newPath ) ){
						...
						if( !$res ){
							...
							$this->output( "deleted $oldPath, exists in media container\n" );
						}
					} else {
