<?php
/**
 * move transcodes from thumb to transcode container
 *
 */
...
class MoveTranscodes extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->mDescription = "move transcodes from thumb to transcode container.";
	}
				...
				if( $file->repo->fileExists( $oldPath ) ){
					if( $file->repo->fileExists( $newPath ) ){
						...
						if( !$res ){
							...
							$this->output( "deleted $oldPath, exists in transcode container\n" );
						}
					} else {
